...
// Hex
// Something something Sailor Moon is pretty cool

/**
 * This class contains all the components to allow PolyWhirl to properly draw a hexagon around the X-Y position specified.
 *
...
public class Hex extends BasicShape {
	...
	public void draw(Graphics g) {
		...
		xPoints.add(this.x);
		xPoints.add(this.x + (int)(30 * Math.cos(Math.toRadians(30))));
		xPoints.add(this.x + (int)(30 * Math.cos(Math.toRadians(-30))));
		xPoints.add(this.x + (int)(30 * Math.cos(Math.toRadians(-90))));
		xPoints.add(this.x + (int)(30 * Math.cos(Math.toRadians(-150))));
		xPoints.add(this.x + (int)(30 * Math.cos(Math.toRadians(150))));

		// Create the y coordinates of vertices of the Polygon
		yPoints.add(this.y + 30);
		yPoints.add(this.y + (int)(30 * Math.sin(Math.toRadians(30))));
		yPoints.add(this.y + (int)(30 * Math.sin(Math.toRadians(-30))));
		yPoints.add(this.y + (int)(30 * Math.sin(Math.toRadians(-90))));
		yPoints.add(this.y + (int)(30 * Math.sin(Math.toRadians(-150))));
		yPoints.add(this.y + (int)(30 * Math.sin(Math.toRadians(150))));
		 ...
		 */
		// specify the color
		Color strokeColor = new Color(0, 255, 0, 220);
		...
		Color fillColor = new Color(0, 255, 0, 220);
