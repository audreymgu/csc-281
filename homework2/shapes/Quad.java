...
// Quad
// The height of geometic perfection

/**
 * This class contains all the components to allow PolyWhirl to properly draw a square around the X-Y position specified.
 *
...
public class Quad extends BasicShape {
	...
	public void draw(Graphics g) {
		 ...
		 */
		// specify the color
		Color strokeColor = new Color(255, 255, 0, 220);
		...
		Color fillColor = new Color(255, 255, 0, 220);
